...
\newcommand{\topic}{Topic Modeling of Patient Opinion}
...
\begin{figure}[tp]
    \begin{center}
    \epsfig{figure=Figs/anni005_no_slope.jgr.ps,width=16.7cm}
    \caption
    [Short title to appear in List of Figures]
    {
    Long title to appear in the caption
    \label{fig-MyImportantGraph}
    }
    \end{center}
\end{figure}
